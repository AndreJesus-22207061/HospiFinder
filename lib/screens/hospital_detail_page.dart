...
class HospitalDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<LocationData>(
      future: snsRepository.locationModule
          .onLocationChanged()
          .first,
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4),
                                      Text(
                                        "${hospital.distanciaDe(
                                            userLat, userLon).toStringAsFixed(
                                            1)} km",
                                        style: Theme
                                            .of(context)
                                            .textTheme
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Center(child: Text("Avaliações", style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.black))),
                            SizedBox(height: 10),
                            ...hospital.avaliacoes.isNotEmpty
                              ...
                              final estrelas = snsRepository
                                  .gerarEstrelasParaAvaliacao(avaliacao);
