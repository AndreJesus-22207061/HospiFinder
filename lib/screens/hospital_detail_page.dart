        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return FutureBuilder<Hospital>(
              ...
              builder: (context, snapshot) {
                print('[DEBUG] FutureBuilder hospital: estado=${snapshot.connectionState}');
                if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return FutureBuilder<List<EvaluationReport>>(
                  ...
                  builder: (context, snapshot) {
                    print('[DEBUG] FutureBuilder avaliações: estado=${snapshot.connectionState}');
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      return Padding(
                    ...
                    for (var i = 0; i < hospital.reports.length; i++) {
                      print('[DEBUG] Avaliação #$i: rating=${hospital.reports[i].rating}, data=${hospital.reports[i].dataHora}, notas=${hospital.reports[i].notas}');
                    }
                                  ...
                                  children: [
                                    ...
                                    ...hospital.reports.isNotEmpty
                                        ? hospital.reports
                                            ...
                                            print('Número de avaliações: ${hospital.reports.length}');
                                            print('Avaliacao #$index: rating=${avaliacao.rating}, date=${avaliacao.dataHora}, notas=${avaliacao.notas}');
